			...
			<div class="modal-dialog" role="document">
				<div class="modal-content" style="font-size: 18px;">
					...
					<div class="modal-footer">
						<button type="button" id="btnCancelar" class="btn btn-danger" data-dismiss="modal" style="font-size: 16px;">Cancelar Cupo</button>
						<button type="button" id="btnModificar" class="btn btn-success" data-dismiss="modal" style="font-size: 16px;">Modificar</button>
						<button type="button" id="btnActualizar" class="btn btn-success" data-dismiss="modal" style="font-size: 16px;">Actualizar datos</button>
