    ...
    <div class="row justify-content-center" style="color: white; background-color: rgba(0, 0, 0, 0.8);border-radius:9px; width: 95%;">
        ...
        <div class="usu">
            ...
            <table class="table table-bordered table-responsive" style="width: 95%;">
                ...
                <?php
               $ccmsU = $_SESSION['ccmsUsuario'];
                $consulta = "SELECT fechaPeticion, horaPeticion, nombreEvaluado, tipoIdentificacion, numeroIdentificacion, cargoEvaluado, areaEvaluado, ciudadPeticion, tipoConvocatoria
                FROM solicitud_poli WHERE estadoPeticion = 'Solicitado' and  ccmsRegistrador = '$ccmsU'";
            ...
            <br>
            <a href="solicitud.php" class="btn btn-danger" style = "width: 20%; font-size: 15px;font-family: 'Segoe UI';"><i class="fa fa-plus" aria-hidden="true"></i>  Nueva solicitud</a><br><br>
