    ...
    <div class="container" align="center">
      ...
      <div class="row justify-content-center" style="color: white; background-color: rgba(0, 0, 0, 0.8);border-radius:10px; width: 70%;">
        ...
        <div class="form-group" style="width: 100%;">
          ...
          <label class="checkbox-inline" style="font-size: 13px; font-family: 'Segoe UI';">
            <input type="checkbox" id="checkboxPreliminar" value="opcion_3" onclick="mostrarPreliminar()"> Informe Preliminar
          </label>
       ...
       {  
        ...
        {  
          ...
          $sql = "SELECT nombreExamen FROM datos_generales_poli  WHERE no_id = ".$idpersona.";";  
          $result = odbc_exec($connect, $sql);  
          $p=0;
          $hid = "";
          while ($row = odbc_fetch_array($result)){
        ...
        {  
          ...
          $sql = "SELECT fechacreacion, ciudadexamen, tipoexamen, motivoexamen, estadoexamen, t_identificacion, no_id, nombre, areaaspira, cargoaspira, color, estadocolor, notasft, solicitador, cargosolicitador, poligrafista, nombreExamen  FROM datos_generales_poli  WHERE no_id = ".$idpersona.";";  
          $result = odbc_exec($connect, $sql);  
          ...
          {       
            ...
            <th width="45%">'.utf8_encode($row["no_id"]).'</th> 
            </tr> 
            <tr>  
            ...
            <th width="45%">'.utf8_encode($row["color"]).' '.utf8_encode($row["estadocolor"]).'</th> 
            </tr> 
            <tr>  
        ...
        <form method="post" action="crearPDF.php" target="_blank">
          ...
          <div class="exportar" hidden>
            ...
            <br><br><div class="examenCompleto" <?php echo ($hid) ?>>
              <label>¡El examen completo está disponible!</label><br>
              <a href="../../../poligrafia_files/<?php echo($neim) ?>.pdf" target="blank" class="btn btn-success" style="font-size: 16px; width: 35%;">Ver examen completo</a></div>
        ...
        <script type="text/javascript">
          function mostrarValidar(){
            if ((document.getElementById("checkboxConcepto").checked==false) && (document.getElementById("checkboxNovedad").checked==false) && (document.getElementById("checkboxPreliminar").checked==false) ){
              $(".tblNovedad").attr('hidden', true);
              $(".tblPreliminar").attr('hidden', true);
          ...
          function mostrarConcepto(){
            ...
            document.getElementById("checkboxPreliminar").checked = false;
            $(".tblNovedad").attr('hidden', true);
            $(".tblPreliminar").attr('hidden', true);
          ...
          function mostrarPreliminar(){

            document.getElementById("checkboxNovedad").checked = false;
            document.getElementById("checkboxConcepto").checked = false;
            $(".tblNovedad").attr('hidden', true);
            $(".tblPreliminar").attr('hidden', false);
            $(".tblConcepto").attr('hidden',true);
            document.getElementById("tipo").value = "Preliminar";
            $(".exportar").attr('hidden',false);
            mostrarValidar();
          }
